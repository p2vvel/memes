...
class TestCommentsFetch(TestCase):
    def setUp(self):
        ...
        for k in image_paths:
            ...
            new_meme = Meme(title=title, description=description, original_image=original_image,
                            original_poster=new_user)
    ...
    def test_comments_new(self):
        ...
        self.assertEqual([k[0] for k in expected_comments], [k["fields"]["content"] for k in data["comments"]])

    def test_comments_new_no_sort_parameter(self):
